    ...
    <div>
      <div className="row">
        <div className="col-md-9">
          ...
          <p> Moving foward, I look to be programming for an organization whose mission I am passionate about.  Wherever I go, I will always be teaching and learning.  </p>
        </div>
