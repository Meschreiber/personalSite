    ...
    <div>
      <div className="row">
        <div className="col-md-9">
          ...
          <p> Moving foward, I look to be programming for an organization whose mission I am passionate about.  I am particularly interested in applying my software engineeringand data analytics skills in education, biological research, or healthcare.  Wherever I go, I will always be teaching and learning.  </p>
